...
public class Thiseas {
	...
	public static boolean isExit(String[][] maze, int index){
	...
	public static String[] check(String[][] maze, int index){
	...
	public static void solve(String[][] maze){
		...
		while(!isExit(maze, index)){
			String[] tmp = check(maze, index);
	...
	public static void error(int code){
		switch(code){
			case 1:
				...
				break;
			case 2:
				System.out.println("Error: Wrong entrance data given");
				break;
			case 3:
				System.out.println("Error: Wrong matrix data given");
				break;
			case 4:
			  System.out.println("Error: Wrong matrix data given");
				break;
			case 5:
				System.out.println("Error: No entrances found");
				break;
			case 6:
				System.out.println("Error: No exits found");
				break;
			default:
